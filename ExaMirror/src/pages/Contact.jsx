...
import { FaInstagram, FaFacebookF, FaYoutube, FaLinkedinIn, FaEnvelope, FaPhoneAlt } from 'react-icons/fa';
...
const SocialIcons = memo(() => (
  <div className="flex gap-3 mt-2">
    <a href="#" aria-label="Instagram" className="text-gray-500 hover:text-pink-600"><FaInstagram size={20} /></a>
    <a href="#" aria-label="Facebook" className="text-gray-500 hover:text-blue-600"><FaFacebookF size={20} /></a>
    <a href="#" aria-label="YouTube" className="text-gray-500 hover:text-red-600"><FaYoutube size={20} /></a>
    <a href="#" aria-label="LinkedIn" className="text-gray-500 hover:text-blue-800"><FaLinkedinIn size={20} /></a>
  </div>
));

const ContactUsSection = () => {
  const [formData, setFormData] = useState({
    name: '', email: '', phone: '', exam: '', message: ''
  });
      ...
      <div className="relative z-10">
        <div className="bg-white rounded-2xl shadow-2xl flex flex-col md:flex-row items-stretch gap-0 md:gap-0 overflow-hidden ">
          ...
          <div className="flex-1 p-8 md:p-10 bg-gray-50">
            ...
            <p className="text-gray-500 mb-6 text-sm">We usually respond within 24 hours.</p>
            <form className="space-y-4" onSubmit={handleSubmit} autoComplete="off" aria-label="Contact form">
              <input
              ...
              <select
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-600"
                required aria-label="Select Exam"
              >
              ...
              <textarea
                name="message" placeholder="Message" value={formData.message}
                onChange={handleChange} rows={3} required
                className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-600"
                aria-label="Message"
              />
              <Button type="submit" variant="primary" className="w-full bg-blue-700 hover:bg-blue-800" aria-label="Submit">
          ...
          <div className="flex-1 p-8 md:p-10 flex flex-col justify-center bg-white ">
            <h2 className="text-xl font-bold text-gray-900 mb-4 text-center">Contact Details</h2>
            <div className="flex justify-center items-center mb-3">
              <FaEnvelope className="text-blue-600 mr-3" />
              <span className="text-gray-700 font-medium ">info@examirror.com</span>
            </div>
            <div className="flex justify-center items-center  mb-3">
            ...
            <div className="mt-3 flex flex-col justify-center items-center">
              <span className="block text-gray-500 text-sm mb-2">Connect With Us</span>
              <SocialIcons />
            </div>
          </div>
        </div>
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 pb-0">
      ...
      <section className="py-12 text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-gray-900 mb-2">Contact Us</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">We'd love to hear from you. Reach out for any queries, feedback, or support.</p>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <h2 className="text-3xl font-bold text-center mb-8">Meet Our Directors</h2>
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          Our experienced directors bring decades of expertise in education and competitive exam preparation
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {directors.map((director, idx) => (
            <div key={idx} className="bg-white rounded-2xl shadow-lg flex flex-col items-center p-8">
              <img
                src={director.img}
                alt={director.name}
                ...
                loading="lazy"
              />
              <h3 className="text-xl font-semibold text-gray-900 mb-1">{director.name}</h3>
              <p className="text-blue-700 font-medium mb-2">{director.title}</p>
              <div className="mb-2 w-full">
                <h4 className="font-semibold text-gray-700 text-sm mb-1">Education</h4>
              ...
              <div className="mb-2 w-full">
                <h4 className="font-semibold text-gray-700 text-sm mb-1">Email</h4>
                <a href={director.mail} className="text-blue-600 text-sm hover:underline break-all">{director.email}</a>
              </div>
              <div className="flex gap-4 mt-2">
                <a href={director.linkedin} className="text-gray-500 hover:text-blue-600" aria-label="LinkedIn"><FaLinkedinIn size={20} /></a>
                <a href={director.facebook} className="text-gray-500 hover:text-blue-600" aria-label="Facebook"><FaFacebookF size={20} /></a>
                <a href={director.mail} className="text-gray-500 hover:text-blue-600" aria-label="Email"><FaEnvelope size={20} /></a>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="bg-gray-900 py-16 mt-16">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl text-sm font-bold text-white mb-6">"DON'T WAIT FOR THE OPPORTUNITY, CREATE IT"</h2>
